...
/**
 * Page Object for Claim Creation with Policy Search functionality
 * Handles the FNOL (First Notice of Loss) wizard screens
 * 
 * @author Enterprise Automation Team
 * @version 1.0
 */
public class ClaimCreationPolicySearchPage extends BasePage {
     ...
     * Constructor
     */
    public ClaimCreationPolicySearchPage() {
        super();
        logger.info("ClaimCreationPolicySearchPage initialized");
    }
     ...
     * 
     * @param time Time in HH:MM format (e.g., "10:10")
    ...
    /**
     * Select No for Email Communication
     * NOTE: This field doesn't exist on the Basic Info screen after claimant selection
     */
    @Step("Select No for Email Communication")
    public void selectEmailCommunicationNo() {
        logger.warn("Email Communication field not found on Basic Info screen - skipping");
    ...
    public void fillClaimantDetails(String claimantName, String relationToInsured, String preferredMethod) {
        ...
        selectEmailCommunicationNo();
        selectPreferredMethodOfContact(preferredMethod);
        selectRequestedNo();
    }
    
    /**
     * Complete claim creation with policy search
     * @param policyNumber Policy number
     * @param lossDate Loss date
     * @param lossTime Loss time
     * @param amPm AM or PM
     ...
     * @param preferredMethod Preferred method of contact
     */
    @Step("Complete Claim Creation with Policy Search")
    public void completeClaimCreationWithPolicySearch(String policyNumber, String lossDate, 
                                                       String lossTime, String amPm, 
                                                       String claimantName, String relationToInsured, 
                                                       String preferredMethod) {
        logger.info("Completing Claim Creation with Policy Search");
